...
ShellRoot {
  ...
  IpcHandler {
    ...
    function state(id: string): string {
      ...
      var probe = ["sink", "source", "volumeSinkName", "focusedMonitor", "monitorScale", "brightnessPercent", "tunedProfile", "tunedAvailable", "cursorActive", "cursorFromKeyboard", "tunedPending", "amphetamineOn", "amphetamineInf", "amphetamineMinutesLeft", "themeMode"]
