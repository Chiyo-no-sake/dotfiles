...
//      writes the result back to layout.json, so the label the bar shows and
...
// entry is current: cycling writes the result back to layout.json, and a
// ring that reshuffled itself around the current value would bounce between
// two entries instead of walking.
